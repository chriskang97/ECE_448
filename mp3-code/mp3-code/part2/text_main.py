...
def load_dataset(data_dir=''):
    ...
    """
    stop_words=read_stop_words(data_dir+'C:/Users/chris/Downloads/ECE_448/mp3-code/mp3-code/part2/stop_words.csv')
    x_train, y_train = readFile(data_dir+'C:/Users/chris/Downloads/ECE_448/mp3-code/mp3-code/part2/train_text.csv',stop_words)
    x_test, y_test = readFile(data_dir+'C:/Users/chris/Downloads/ECE_448/mp3-code/mp3-code/part2/dev_text.csv',stop_words)
